package com.booleanuk.api.employees.controller;

import com.booleanuk.api.employees.model.Employee;
import com.booleanuk.api.employees.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> deleteEmployee(@PathVariable int id){
        Employee employeeToDelete = this.employeeRepository.findById(id).orElseThrow(
                () -> new ResponseStatusException(HttpStatus.NOT_FOUND, "No employees found with that ID")
                );
